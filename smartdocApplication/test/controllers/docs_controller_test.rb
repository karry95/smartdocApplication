...
class DocsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create doc" do
    assert_difference('Doc.count') do
      post docs_url, params: { doc: { date: @doc.date, details: @doc.details, patient: @doc.patient, time: @doc.time } }
    end
  ...
  test "should update doc" do
    patch doc_url(@doc), params: { doc: { date: @doc.date, details: @doc.details, patient: @doc.patient, time: @doc.time } }
